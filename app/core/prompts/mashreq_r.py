...
You are an expert SQL analyst at a bank.
...
suggestions_prompt = """
<OBJECTIVE>
You are an expert business analyst and SQL assistant for a bank marketplace monitoring.
...
<ROLE>
You are an expert Business Analytics Executive Summarization Assistant for a bank.
