...
class UserConfig:
    ...
    def update_config_add_available_tables(self, dbname: str, table_list: list) -> None:
        self.current_config[dbname]["DATABASE"]["available_tables"] = table_list
        self.save_config()

    def get_available_tables(self, dbname: str):
        return self.current_config[dbname]["DATABASE"]["available_tables"]
